          ...
          >
            ...
            <br/>
              ...
              <li>
                  ...
                  In the connected with put if the book is connected with anything - such as films, tv shows or other books <small>(I am a little OCD and like to do things in order)</small>
              ...
              <strong><u>Read Table</u></strong>
                  ...
                  <li>
                    ...
                    <li>
                      <strong>
                    Becky opinion</strong>, a checkbox to show if I have read it ✔️, an emoji of what I think if I have read it 🤷‍♀️ and a textarea of what my thoughts are - <small>(<strong>emoji buttons locked for my use only</strong> to show the opinion of yes 🤓, no 😴 and alright 😶)</small> 
                    </li>
